...
const effects: EffectDef[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'effect.surface.baseSize', uniform: 'uBaseSize', min: 0.5, max: 5.0, step: 0.1, default: 2.0 },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'effect.explosion.baseSize', uniform: 'uBaseSize', min: 0.5, max: 5.0, step: 0.1, default: 2.0 },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'effect.morph.baseSize', uniform: 'uBaseSize', min: 0.5, max: 5.0, step: 0.1, default: 2.0 },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'effect.vortex.baseSize', uniform: 'uBaseSize', min: 0.5, max: 5.0, step: 0.1, default: 2.0 },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'effect.density.baseSize', uniform: 'uBaseSize', min: 0.5, max: 5.0, step: 0.1, default: 2.0 },
    ],
  },
]
