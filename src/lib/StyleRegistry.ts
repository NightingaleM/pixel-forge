...
export const styles: StyleDefinition[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    isMultiPass: true,
    params: [
      { name: 'style.lightshadow.contrast',   uniform: 'uContrast',    min: 0.5, max: 3.0, step: 0.01, default: 2.18, description: 'style.lightshadow.contrastDesc' },
      { name: 'style.lightshadow.threshold', uniform: 'uThreshold',    min: 0.1, max: 0.9, step: 0.01, default: 0.67, description: 'style.lightshadow.thresholdDesc' },
      { name: 'style.lightshadow.glowRadius',   uniform: 'uGlowRadius',  min: 0,   max: 50,  step: 0.1,  default: 15,  description: 'style.lightshadow.glowRadiusDesc' },
      { name: 'style.lightshadow.lightDir', uniform: 'uLightDir',    min: 0,   max: 360, step: 1,    default: 280, description: 'style.lightshadow.lightDirDesc' },
      { name: 'style.lightshadow.glowIntensity',   uniform: 'uGlowIntensity', min: 0.0, max: 2.0, step: 0.01, default: 0.73, description: 'style.lightshadow.glowIntensityDesc' },
      ...
      { name: 'style.lightshadow.shadowDepth',   uniform: 'uShadowDepth',   min: 0.0, max: 2.0, step: 0.01, default: 1.45, description: 'style.lightshadow.shadowDepthDesc' },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    isMultiPass: true,
    params: [
      { name: 'style.animelight.saturation',   uniform: 'uSaturation',     min: 0.5, max: 4.0, step: 0.01, default: 1.36, description: 'style.animelight.saturationDesc' },
      { name: 'style.animelight.edgeWidth', uniform: 'uEdgeWidth',      min: 0.5, max: 5.0, step: 0.1,  default: 1.9, description: 'style.animelight.edgeWidthDesc' },
      { name: 'style.animelight.edgeThreshold', uniform: 'uEdgeThreshold',  min: 0.01, max: 0.5, step: 0.01, default: 0.24, description: 'style.animelight.edgeThresholdDesc' },
      { name: 'style.animelight.godRayStrength', uniform: 'uGodRayStrength', min: 0.0, max: 3.0, step: 0.01, default: 0.78, description: 'style.animelight.godRayStrengthDesc' },
      { name: 'style.animelight.godRayAngle', uniform: 'uGodRayAngle',    min: 0,   max: 360, step: 1,    default: 143, description: 'style.animelight.godRayAngleDesc' },
      { name: 'style.animelight.glowRadius', uniform: 'uGlowRadius',     min: 1,   max: 50,  step: 0.1,  default: 8.9, description: 'style.animelight.glowRadiusDesc' },
      ...
      { name: 'style.animelight.contrast',   uniform: 'uContrast',        min: 0.5, max: 3.0, step: 0.01, default: 1.65, description: 'style.animelight.contrastDesc' },
    ],
  },
