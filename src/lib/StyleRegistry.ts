...
export const styles: StyleDefinition[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.halftone.cellSize',    uniform: 'uCellSize',  min: 2,   max: 50,  step: 1,    default: 6,   description: 'style.halftone.cellSizeDesc' },
      { name: 'style.halftone.dotScale',    uniform: 'uDotScale',  min: 0.1, max: 3.0, step: 0.01, default: 1.0, description: 'style.halftone.dotScaleDesc' },
      ...
      { name: 'style.halftone.shape',    uniform: 'uShape',     min: 0,   max: 2,   step: 1,    default: 0,   description: 'style.halftone.shapeDesc' },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.diffusion.levels',   uniform: 'uLevels',    min: 2,   max: 64,  step: 1,    default: 8,   description: 'style.diffusion.levelsDesc' },
      { name: 'style.diffusion.spread', uniform: 'uSpread',     min: 0.0, max: 2.0, step: 0.01, default: 1.0, description: 'style.diffusion.spreadDesc' },
      { name: 'style.diffusion.pixelSize', uniform: 'uPixelSize', min: 1,   max: 16,  step: 1,    default: 1,   description: 'style.diffusion.pixelSizeDesc' },
      { name: 'style.diffusion.noiseType', uniform: 'uNoiseType',  min: 0,   max: 2,   step: 1,    default: 0,   description: 'style.diffusion.noiseTypeDesc' },
      { name: 'style.diffusion.ditherStrength', uniform: 'uDitherStrength', min: 0.0, max: 1.0, step: 0.01, default: 1.0, description: 'style.diffusion.ditherStrengthDesc' },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.popart.levels', uniform: 'uLevels',     min: 2,   max: 16,  step: 1,    default: 4,   description: 'style.popart.levelsDesc' },
      ...
      { name: 'style.popart.contrast',      uniform: 'uContrast',   min: 0.2, max: 5.0, step: 0.01, default: 1.5, description: 'style.popart.contrastDesc' },
      { name: 'style.popart.palette',    uniform: 'uPalette',    min: 0,   max: 4,   step: 1,    default: 0,   description: 'style.popart.paletteDesc' },
      { name: 'style.popart.benDay',    uniform: 'uBenDay',     min: 0,   max: 1,   step: 1,    default: 0,   description: 'style.popart.benDayDesc' },
      { name: 'style.popart.hueShift',    uniform: 'uHueShift',   min: 0,   max: 360, step: 1,    default: 0,   description: 'style.popart.hueShiftDesc' },
      { name: 'style.popart.dotSize',    uniform: 'uDotSize',    min: 2,   max: 20,  step: 1,    default: 6,   description: 'style.popart.dotSizeDesc' },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    isMultiPass: true,
    params: [
      { name: 'style.lightshadow.contrast',   uniform: 'uContrast',    min: 0.5, max: 3.0, step: 0.01, default: 1.5, description: 'style.lightshadow.contrastDesc' },
      { name: 'style.lightshadow.threshold', uniform: 'uThreshold',    min: 0.1, max: 0.9, step: 0.01, default: 0.5, description: 'style.lightshadow.thresholdDesc' },
      { name: 'style.lightshadow.glowRadius',   uniform: 'uGlowRadius',  min: 0,   max: 50,  step: 0.1,  default: 5,   description: 'style.lightshadow.glowRadiusDesc' },
      ...
      { name: 'style.lightshadow.glowIntensity',   uniform: 'uGlowIntensity', min: 0.0, max: 2.0, step: 0.01, default: 1.0, description: 'style.lightshadow.glowIntensityDesc' },
      ...
      { name: 'style.lightshadow.shadowDepth',   uniform: 'uShadowDepth',   min: 0.0, max: 2.0, step: 0.01, default: 1.0, description: 'style.lightshadow.shadowDepthDesc' },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.sketch.edgeWidth',   uniform: 'uEdgeWidth',    min: 0.5, max: 10.0, step: 0.1,  default: 1.0, description: 'style.sketch.edgeWidthDesc' },
      { name: 'style.sketch.sensitivity', uniform: 'uSensitivity',   min: 0.01, max: 1.0, step: 0.01, default: 0.1, description: 'style.sketch.sensitivityDesc' },
      { name: 'style.sketch.detail',   uniform: 'uDetail',        min: 0.0, max: 1.0, step: 0.01, default: 0.5, description: 'style.sketch.detailDesc' },
      ...
      { name: 'style.sketch.lineColor',     uniform: 'uLineColor',     min: 0,   max: 360, step: 1,    default: 0,   description: 'style.sketch.lineColorDesc' },
      ...
      { name: 'style.sketch.edgeMethod', uniform: 'uEdgeMethod',   min: 0,   max: 1,   step: 1,    default: 0,   description: 'style.sketch.edgeMethodDesc' },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.pointillism.dotSize', uniform: 'uDotSize',        min: 2,   max: 60,  step: 1,    default: 8,   description: 'style.pointillism.dotSizeDesc' },
      { name: 'style.pointillism.density',     uniform: 'uDensity',        min: 0.1, max: 5.0, step: 0.01, default: 1.0, description: 'style.pointillism.densityDesc' },
      { name: 'style.pointillism.randomness', uniform: 'uRandomness',     min: 0.0, max: 1.0, step: 0.01, default: 0.3, description: 'style.pointillism.randomnessDesc' },
      { name: 'style.pointillism.sizeVariation', uniform: 'uSizeVariation', min: 0.0, max: 1.0, step: 0.01, default: 0.0, description: 'style.pointillism.sizeVariationDesc' },
      { name: 'style.pointillism.dotOpacity', uniform: 'uDotOpacity',   min: 0.1, max: 1.0, step: 0.01, default: 1.0, description: 'style.pointillism.dotOpacityDesc' },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'style.kaleidoscope.edgeGlow', uniform: 'uEdgeGlow',  min: 0.0, max: 2.0, step: 0.01, default: 0.0, description: 'style.kaleidoscope.edgeGlowDesc' },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    isMultiPass: true,
    params: [
      { name: 'style.animelight.saturation',   uniform: 'uSaturation',     min: 0.5, max: 4.0, step: 0.01, default: 1.8, description: 'style.animelight.saturationDesc' },
      { name: 'style.animelight.edgeWidth', uniform: 'uEdgeWidth',      min: 0.5, max: 5.0, step: 0.1,  default: 1.5, description: 'style.animelight.edgeWidthDesc' },
      { name: 'style.animelight.edgeThreshold', uniform: 'uEdgeThreshold',  min: 0.01, max: 0.5, step: 0.01, default: 0.1, description: 'style.animelight.edgeThresholdDesc' },
      { name: 'style.animelight.godRayStrength', uniform: 'uGodRayStrength', min: 0.0, max: 3.0, step: 0.01, default: 1.0, description: 'style.animelight.godRayStrengthDesc' },
      { name: 'style.animelight.godRayAngle', uniform: 'uGodRayAngle',    min: 0,   max: 360, step: 1,    default: 135, description: 'style.animelight.godRayAngleDesc' },
      { name: 'style.animelight.glowRadius', uniform: 'uGlowRadius',     min: 1,   max: 50,  step: 0.1,  default: 10,  description: 'style.animelight.glowRadiusDesc' },
      ...
      { name: 'style.animelight.contrast',   uniform: 'uContrast',        min: 0.5, max: 3.0, step: 0.01, default: 1.3, description: 'style.animelight.contrastDesc' },
    ],
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      { name: 'style.textraster.cellSize',     uniform: 'uCellSize',       min: 4,   max: 40,  step: 1,    default: 12,  description: 'style.textraster.cellSizeDesc' },
      ...
      { name: 'style.textraster.bgBrightness',     uniform: 'uBgBrightness',   min: 0.0, max: 1.0, step: 0.01, default: 0.0, description: 'style.textraster.bgBrightnessDesc' },
      { name: 'style.textraster.colorStrength',     uniform: 'uColorStrength',  min: 0.0, max: 2.0, step: 0.01, default: 1.0, description: 'style.textraster.colorStrengthDesc' },
