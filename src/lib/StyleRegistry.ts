...
export const styles: StyleDefinition[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    params: [
      ...
      { name: 'style.animelight.godRayStrength', uniform: 'uGodRayStrength', min: 0.0, max: 3.0, step: 0.01, default: 0,   description: 'style.animelight.godRayStrengthDesc' },
      { name: 'style.animelight.godRayAngle', uniform: 'uGodRayAngle',    min: 0,   max: 360, step: 1,    default: 0,   description: 'style.animelight.godRayAngleDesc' },
